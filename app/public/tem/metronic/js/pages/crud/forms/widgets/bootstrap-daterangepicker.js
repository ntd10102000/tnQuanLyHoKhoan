...
var KTBootstrapDaterangepicker = (function () {
  ...
  var demos = function () {
    ...
    $("#khoangThoiGianTruocLu").daterangepicker(
      {
        buttonClasses: " btn",
        applyClass: "btn-primary",
        cancelClass: "btn-secondary",
      ...
      function (start, end, label) {
        $("#khoangThoiGianTruocLu .form-control").val(
          start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD")
        );
      }
    );

    $("#khoangThoiGianSauLu").daterangepicker(
      {
        buttonClasses: " btn",
        applyClass: "btn-primary",
        cancelClass: "btn-secondary",
      ...
      function (start, end, label) {
        $("#khoangThoiGianSauLu .form-control").val(
          start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD")
        );
      }
    );

    $("#khoangThoiGianTrai").daterangepicker(
      {
        buttonClasses: " btn",
        applyClass: "btn-primary",
        cancelClass: "btn-secondary",
      ...
      function (start, end, label) {
        $("#khoangThoiGianTrai .form-control").val(
          start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD")
        );
      }
    );

    $("#khoangThoiGianPhai").daterangepicker(
      {
        buttonClasses: " btn",
        applyClass: "btn-primary",
        cancelClass: "btn-secondary",
      ...
      function (start, end, label) {
        $("#khoangThoiGianPhai .form-control").val(
          start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD")
        );
      }
    );
